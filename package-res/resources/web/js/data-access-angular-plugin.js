...
require(deps, function(PUCAngularPlugin, controllers, services, directives) {
	...
	var routes = function($routeProvider) {
		$routeProvider
			...
			.when("/data-access/edit-data-source-connection", {
			...
			.when("/data-access/import-analysis", {
				templateUrl : "content/data-access-v2/resources/web/partials/import-analysis.html",
				controller : "ImportAnalysisController"
			})
			.when("/data-access/import-metadata", {
				templateUrl : "content/data-access-v2/resources/web/partials/import-metadata.html",
				controller : "ImportMetadataController"
			});
	}
